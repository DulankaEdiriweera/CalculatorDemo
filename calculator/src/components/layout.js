    ...
    return(
        <div className='frame'>
            <div className="calculator">
                ...
                <div className="keys">
                    <input type="button" value={'C'} className="buttonClear" onClick={handleClick}></input>
                    <input type="button" value={'DEL'} className="buttonClear" onClick={handleClick}></input>
                    <input type="button" value={'%'} className="buttonOperator" onClick={handleClick}></input>
                    <input type="button" value={'/'} className="buttonOperator" onClick={handleClick}></input>
                    ...
                    <input type="button" value={'='} className="equal" onClick={handleClick}></input>
